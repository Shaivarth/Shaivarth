...
* Log analysis, SIEM monitoring, and threat investigation

Currently building hands-on experience through:

* Platforms like TryHackMe and Hack The Box
* Working with Splunk and Microsoft Sentinel in security labs
* Analyzing Windows/Linux logs and investigating suspicious activity
* Practicing with Kali Linux and cybersecurity tools
* Writing basic Python scripts for automation and security tasks

Also preparing for the Certified Ethical Hacker (CEH) certification while strengthening knowledge in:

* Security monitoring and alert triage
* Network security and attack methodologies
...
![MITRE ATT&CK](https://img.shields.io/badge/MITRE_ATT%26CK-E3001B?style=for-the-badge&logo=mitre&logoColor=white)
...
![TryHackMe Stats](https://tryhackme-badges.s3.amazonaws.com/Shaivarth.png?timestamp=20260512024209)
